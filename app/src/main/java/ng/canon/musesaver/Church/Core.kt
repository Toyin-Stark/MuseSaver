package ng.canon.musesaver.Church
...
class Core : AppCompatActivity() {
    ...
    fun mrSave(urld: String){
        ...
        Toast.makeText(this@Core,""+getString(R.string.downloadStart),Toast.LENGTH_LONG).show()
        val rxDownloader = RxDownloader(this@Core)
        var extension = "mp4"
        var desc = ""
        desc = getString(R.string.downloadVideo)
        val timeStamp =  System.currentTimeMillis()
        val filename = "musically_"+"_"+timeStamp
        ...
        request.setDestinationInExternalPublicDir("/musesavers",  name)
